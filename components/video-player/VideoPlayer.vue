...
import {getOnlineTotal, getVideoPlayConfig, getVideoPlayer} from "@/api/video";
import {getRange, setSourceBuffer} from "@/api/play";
import Image from "@/components/Image.vue";
import type {Audio, OnlineTotal, Video, VideoPlayConfig, VideoPlayer, VideoView} from "@/api/types/video";
...
watch(() => props.videoView, async (newVideoView) => {
  ...
  onMounted(() => {
    setOnlineTotalTimer(newVideoView)
  })
